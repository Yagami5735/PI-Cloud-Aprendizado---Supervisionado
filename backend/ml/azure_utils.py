...
AZURE_CONTAINER_UPLOADS = os.getenv('AZURE_CONTAINER_UPLOADS', 'uploads')
AZURE_CONTAINER_MODELS = os.getenv('AZURE_CONTAINER_MODELS', 'modelo')
AZURE_CONTAINER_DATA = os.getenv('AZURE_CONTAINER_DATA', 'graficos')
